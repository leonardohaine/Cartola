...
public class Pontos_ {
    ...
    public Pontos_ withRodada(double rodada) {
        this.rodada = rodada;
        return this;
    }
    ...
    public Pontos_ withMes(double mes) {
        this.mes = mes;
        return this;
    }
    ...
    public Pontos_ withTurno(double turno) {
        this.turno = turno;
        return this;
    }
    ...
    public Pontos_ withCampeonato(double campeonato) {
        this.campeonato = campeonato;
        return this;
    }
    ...
    public Pontos_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
